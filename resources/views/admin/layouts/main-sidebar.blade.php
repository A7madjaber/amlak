...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج العقارات</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('admin.building.index')}}">قائمة العقارات</a></li>
                    <li><a class="slide-item" href="{{route('admin.types.index')}}">انواع العقارات</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="">
                    <i class="fa fa-lg fa-users m-2"></i>

                    <span class="side-menu__label">المستخدمين</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('admin.user.index')}}">قائمة المستخدمين</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="">
                    <i class="fa fa-lg fa-mail-bulk m-2"></i>

                    <span class="side-menu__label">رسائل الزوار</span><span class="badge badge-danger ml-1">{{count(\App\Message::where('is_read',0)->get())}}</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('admin.messages.index')}}">قائمة رسائل الزوار</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{route('admin.setting.index')}}">
                    <i class="fa fa-lg fa-edit m-2"></i>
