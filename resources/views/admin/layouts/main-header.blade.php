                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <button id="markReadAll" data-route="{{route('admin.MarkReadAll')}}" class="btn btn-info-gradient btn-sm bad mr-auto my-auto float-left">تعيين الكل كمقروء</button>
                            </div>
                            <div id="count">
                                <h6  class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
                        ...
                        <div id="unNotif">
                            ...
                            @foreach(auth()->user()->unreadNotifications as $notification)
                                ...
                                <div class="main-notification-list Notification-scroll">
                                    ...
                                    <a class="d-flex p-3 border-bottom" href="{{route('admin.building.edit',$notification->data['id'])}}">
